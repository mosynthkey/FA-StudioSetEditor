...
function FA(midi, toCtrl)
{
  ...
  if (this.fain != null && this.faout != null) midi.setInOut(this.fain, function(e) {this_.onMidiMsg(e, this_.toCtrl);}, this.faout);
...
FA.prototype.onMidiMsg = function(event, toCtrl)
{
  ...
  if (msg.cmphead(irm_head)) {
    ...
    if (msg.cmptail(irm_tail_06) || msg.cmptail(irm_tail_08)) {
